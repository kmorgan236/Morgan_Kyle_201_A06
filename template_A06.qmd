...
```{r}
height = 78
player_info$MJ = append(player_info$MJ, height, after = 5)

height = 81
player_info$LJ = append(player_info$LJ, height, after = 5)

height = 78
player_info$KB = append(player_info$KB, height, after = 5)

height = 86
player_info$KA = append(player_info$KA, height, after = 5)

height = 85
player_info$SO = append(player_info$SO, height, after = 5)
