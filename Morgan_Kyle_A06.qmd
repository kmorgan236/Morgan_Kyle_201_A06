...
print(paste0("The Colorado maximum median annual temperature of ", max_median_temp, " occurred in ", yr_max_median, " and the minimum median annual temperature of ", min_median_temp, " occurred in ", yr_min_median, "."))
```
